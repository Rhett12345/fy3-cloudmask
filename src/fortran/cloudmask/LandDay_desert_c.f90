...
!----------------------------------------------------------------------
      if (nint(masir11) .ne. nint(bad_data) .and.  &
        ...
        if (masdf1.le.lds11_12hi_c(2)) then
          nmtests = nmtests + 1
          call set_bit(testbits,18)
          nptests = nptests + 1
          ngtests(1) = ngtests(1) + 1
        end if
        call conf_test(masdf1,lds11_12hi_c(1),lds11_12hi_c(3),   &
                       lds11_12hi_c(4),lds11_12hi_c(2),1,c1)
        cmin1 = min(cmin1,c1)
      endif
...
!----------------------------------------------------------------------
      if (visusd) then
        if (nint(masir11) .ne. nint(bad_data) .and.   &
          ...
          if (mas11_4.ge.lds11_4lo_c(2)) then
            nmtests = nmtests + 1
          ...
          call conf_test(mas11_4,lds11_4lo_c(1),lds11_4lo_c(3),   &
                         lds11_4lo_c(4),lds11_4lo_c(2),1,c2)
          call conf_test(mas11_4,lds11_4hi_c(1),lds11_4hi_c(3),   &
                         lds11_4hi_c(4),lds11_4hi_c(2),1,c3)
