...
! ... local scalars ..
      real c1,c2,c3,c4,c5,cosvza,dfthrsh,diftemp,dtr,mas11_4,masdf1,   &
           masir11,masir12,masir4,masv188,masv88,pi,schi,           &
...
! ... debug statement ............................................
!      if (debug .gt. 0) then
!        write(h_output,'(10x/,''Subroutine PolarDay_desert '',/)')
!      endif
! ................................................................
...
!        nmtests = nmtests + 1
!        call set_qa_bit(qa_bits,15)
!        if (masir65 .gt. pdsh20(2)) then
!          call set_bit(testbits,15)
!          nptests = nptests + 1
!        end if
!        call conf_test(masir65,pdsh20(1),pdsh20(3),pdsh20(4),
!     *                 pdsh20(2),1,c2)
!        cmin1 = min(cmin1,c2)
!        ngtests(1) = ngtests(1) + 1
!      endif
...
! ... debug statement ............................................
!      if (debug .gt. 0) then
!        write(h_output,'(1x,''masir65: '',5f10.2)') masir65,pdsh20(1),
!     +          pdsh20(2),pdsh20(3),pdsh20(4)
!      endif
! ................................................................
      ...
      if (visusd) then
        if (nint(masir11) .ne. nint(bad_data) .and.   &
          ...
          if(masir11 .le. 320.0) then
            ...
            if (mas11_4.ge.pds11_4lo(2) .and. mas11_4.le.pds11_4hi(2))then
              call set_bit(testbits,19)
              nptests = nptests + 1
            end if
            locuta(1) = pds11_4lo(1)
            locuta(2) = pds11_4hi(1)
            hicuta(1) = pds11_4lo(3)
            hicuta(2) = pds11_4hi(3)
            midpta(1) = pds11_4lo(2)
            midpta(2) = pds11_4hi(2)
...
! ..... debug statement ............................................
!        if (debug .gt. 0) then
!        write(h_output,'(1x,''mas11_4a: '',5f10.2)')mas11_4,pds11_4lo(1),
!     +              pds11_4lo(2),pds11_4lo(3),pds11_4lo(4)
!        write(h_output,'(1x,''mas11_4b: '',5f10.2)')mas11_4,pds11_4hi(1),
!     +              pds11_4hi(2),pds11_4hi(3),pds11_4hi(4)
!        endif
! ..................................................................
      endif
...
!  ...  debug statement ............................................
!        if (debug .gt. 0) then
!          write(h_output,'(1x,''masv88: '',5f10.2)') masv88,pdsref2(1),
!     +            pdsref2(2),pdsref2(3),pdsref2(4)
!        endif
! ..................................................................
      endif
...
! ...   debug statement ............................................
!        if (debug .gt. 0) then
!           write(h_output,'(1x,''masv188: '',6f10.4)')masv188,pdsref3(1),
!     +                pdsref3(2),pdsref3(3),pdsref3(4)
!        endif
! ................................................................
      endif
