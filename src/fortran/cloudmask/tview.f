...
c ... data statements ..
     ...
     *           260.,270.,280.,290.,300.,310./
      data (tab(i,1),i=1,5)/18.0,16.0,14.0,12.0,10.0/
      data (tab(i,2),i=1,5)/17.0,15.0,13.0,11.0,9.0/
      data (tab(i,3),i=1,5)/16.0,14.0,12.0,10.0,8.0/
      data (tab(i,4),i=1,5)/15.0,13.0,11.0,9.0,7.0/
      data (tab(i,5),i=1,5)/14.0,12.0,10.0,8.0,6.0/
      data (tab(i,6),i=1,5)/13.0,11.0,9.0,7.0,5.0/
      data (tab(i,7),i=1,5)/12.0,10.0,8.0,6.0,4.0/
      data (tab(i,8),i=1,5)/11.0,9.0,7.0,5.0,3.0/
      data (tab(i,9),i=1,5)/10.0,8.0,6.0,4.0,2.0/
      data (tab(i,10),i=1,5)/9.0,7.0,5.0,3.0,1.0/
      data (tab(i,11),i=1,5)/8.0,6.0,4.0,2.0,0.0/
      data (tab(i,12),i=1,5)/7.0,5.0,3.0,1.0,-1.0/
      data (tab(i,13),i=1,5)/6.0,4.0,2.0,0.0,-2.0/
c ...
