...
!
!      For nighttime polar ocean the groups are:
...
!                   11 micron spatial variability test
!                   7.3-8.6 test
!
!!Input Parameters:
! indat         Input radiance data
! kele          Pixel number
...
!               5 km of shoreline
! uniform       Logical variable indicating uniform conditions in context
!
!!Output Parameters:
...
! ... Water vapor cloud test (but not over very cold water).
