...
void opt_med3_int1_(pixelvalue * p, pixelvalue * median)
{
...
void opt_med5_int1_(pixelvalue * p, pixelvalue * median)
{
...
void opt_med7_int1_(pixelvalue * p, pixelvalue * median)
{
...
void opt_med9_int1_(pixelvalue * p, pixelvalue * median)
{
...
/*----------------------------------------------------------------------------
   ...
   Notice   :   in theory, cannot go faster without assumptions on thegradient2d
                signal.
  				Code taken from Graphic Gems.
 ---------------------------------------------------------------------------*/

void opt_med25_int1_(pixelvalue * p, pixelvalue * median)
{
